  ...
  <div class="mx-auto max-w-7xl sm:py-8 lg:py-20 lg:pb-8">
    <div class="mt-12 grid grid-cols-6 gap-8 xl:col-span-12 xl:mt-0">
      ...
      <div class="col-span-3 sm:col-span-2 lg:col-span-1">
        ...
        <ul role="list" class="mt-4 space-y-2">
          <li>
            <a href="https://www.facebook.com/TripSupport.BookNowPayLater" target="_blank" rel="noopener nofollow noreferrer" class="flex items-center px-4 py-2 mr-3 text-xs font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700"><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-facebook mr-2 -ml-1 w-4 h-4" viewBox="0 0 16 16">
  ...
  <div class="max-w-7xl mx-auto">
    <div class="py-6 md:flex md:items-center md:justify-between border-t">
      ...
      <div class="sm:hidden grid grid-cols-2">
        <div>
          <a href="<?php echo home_url() ?>/terms-conditions" class="text-xs font-medium text-gray-500 hover:text-gray-600">Terms & Conditions</a>
        </div>
        <div>
          <a href="<?php echo home_url() ?>/baggage-policy" class="text-xs font-medium text-gray-500 hover:text-gray-600">Baggage Policy</a>
        </div>
        <div class="pt-2">
          <a href="<?php echo home_url() ?>/privacy-policy" class="text-xs font-medium text-gray-500 hover:text-gray-600">Privacy Policy </a>
        </div>
        <div class="pt-2">
          <a href="<?php echo home_url() ?>/pay-later-terms" class="text-xs font-medium text-gray-500 hover:text-gray-600">Pay Later Terms</a>
        </div>
      </div>
