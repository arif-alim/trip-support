      ...
      <section class="overflow-hidden text-gray-700">
        <div class="container px-4 py-2 mx-auto ">
          <?php if (!empty($Travel_Guide[0]['Travel_Guide_Title'])) { ?>
            <div class="sm:flex sm:items-baseline sm:justify-between mt-4 mb-12">
            ...
            <?php if (!empty($images)) { ?>
              ...
              <div class="flex flex-wrap w-1/2">
                <div class="w-full p-1 md:p-2">
                  <img alt="gallery" class="block object-cover object-center w-full h-full rounded-lg" src="<?php if (!empty($images))  echo $item1 ?>">
                </div>
              <?php } ?>
              </div>
              ...
              <div class="flex flex-wrap w-1/2">
                <div class="w-full p-1 md:p-2">
                  <?php if (!empty($map_url)) { ?>
                    <iframe src="<?php echo $map_url . '&output=embed' ?>" class="rounded-lg w-full h-80" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        ...
                        <div class="w-full bg-white border border-gray-100 rounded-lg p-4 my-4">
                          <button class="faq-btn flex w-full justify-between items-center">
                            <div class="text-left w-full">
                              <h1 class="tracking-tight font-extrabold text-gray-900 text-xl">
      ...
      <section class="relative z-20 overflow-hidden ">
        <div class="container">
          <div class="flex flex-wrap">
            <div class="w-full px-4">
              <div class="mb-6 lg:mb-10 max-w-[520px]"><span class="font-normal text-tiny block text-rose-600">FAQs </span>
            ...
            <script type="application/ld+json">
              {
                ...
                "mainEntity": [
                    <?php $cnt_for = 0;
                    $cnt_q = count($questions);
                    if ($cnt_q > 4) $cnt_for = 4;
                    else $cnt_for = $cnt_q;
                    if ($cnt_q != 0) {
                      for ($i = 0; $i < $cnt_for; ++$i) {
                    ?> {
                          "@type": "Question",
                          "name": "<?php echo $questions[$i]['question'] ?>",
                          "acceptedAnswer": {
                            "@type": "Answer",
                            "text": "<?php echo $questions[$i]['answer'] ?>"
                          }
                        }
                        <?php echo ($i == $cnt_for - 1) ? ']}' : ','; ?>
                    <?php  }
                    } ?>
            </script>
        ...
        <section class="relative py-4">
          <div class="text-left max-w-4xl">
            <div class="sm:flex sm:items-baseline sm:justify-between">
              <h1 class="text-xl tracking-tight font-extrabold text-white sm:text-2xl md:text-3xl"><span class="block xl:inline">
