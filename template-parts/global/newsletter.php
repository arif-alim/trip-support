                    ...
                    <form action="#" method="post" id="revue-form" name="revue-form" target="_blank">
                        <div class="flex items-end mb-3">
                            <div class="relative mr-3 w-full revue-form-group">
                                <label for="member_email" class="hidden text-sm font-medium text-gray-900">Email address</label>
                                ...
                                <input class="revue-form-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-pblue-500 focus:border-pblue-500 block w-full pl-10 p-2" placeholder="Your email address..." type="email" name="member[email]" id="member_email" required="" />
                            </div>
                            <div class="revue-form-actions my-auto">
                                <input type="submit" value="Subscribe" class="cursor-pointer text-slate-900 bg-gray-200 hover:bg-pblue-900 hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center" name="member[subscribe]" id="member_submit" />
                            </div>
                        </div>
                        <div class="text-sm text-slate-900 revue-form-footer">
                            By subscribing, you agree with Revue’s
                            <a target="_blank" rel="nofollow" href="https://www.getrevue.co/terms" class="text-slate-900 font-bold hover:underline">Terms of Service</a>
                            and
