<div class="relative bg-slate-900 -mt-1">
	...
	<div class="block sm:hidden">
		<div class="block relative mx-auto px-4 pb-10 pt-4">
	...
	<div class="hidden sm:block">
		<div class="block relative mx-auto px-4 py-12 sm:max-w-7xl sm:py-20 md:py-28 lg:pb-44 lg:pt-24">
		...
		<div class="block relative h-56 bg-white sm:h-72 md:absolute md:right-0 md:top-0 md:h-full md:w-1/2">
			<img class="w-full h-full object-cover" src="<?php echo get_the_post_thumbnail_url(get_the_ID(), '1920x1280'); ?>" alt="vacation deals">
