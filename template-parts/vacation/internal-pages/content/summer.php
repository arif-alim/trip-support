  ...
  <div class="lg:flex lg:text-left container items-center gap-12">
    <div class="lg:w-2/3 lg:items-center">
      <div class="text-slate-900">
        ...
        <p class="text-tiny sm:text-base mb-1 text-justify">
          Let www.tripsupport.ca help you plan your upcoming summer vacation to your definition of paradise. Whether you want something warm, cold, far, or close, they have an option for you. With their “Book Now, Pay Later” program, you only need to make a down payment to secure your reservation, followed by installment payments until the reservation is paid in full prior to traveling. There are no credit checks and no interest on your balance, making it easy to have something to look forward to as you stare out the window at the snow and ice!
        </p>
      </div>
    </div>
    <div class="lg:w-1/3 lg:flex lg:justify-end mt-4">
