<div class="bg-white">
  <div class="max-w-7xl mx-auto py-4 px-4 sm:py-12 sm:px-6 lg:px-8 lg:py-20 mt-6 sm:mt-2">
    <div class="sm:flex sm:items-baseline sm:justify-between">
      ...
      <a href="<?php echo home_url() ?>/blog" class="hidden text-sm font-semibold text-rose-600 hover:text-pblue-900 sm:block">Browse all Blog Posts<span aria-hidden="true">→</span></a>
    </div>
    <div class="max-w-5xl">
  ...
  <div class="mx-auto max-w-md px-4 grid gap-8 sm:max-w-lg sm:px-6 md:grid-cols-2 md:max-w-7xl lg:px-8 lg:grid-cols-3 lg:max-w-7xl lg:py-20">
    <?php
    $args_all = array(
      'post_type' => 'post',
      'posts_per_page' => 3,
          ...
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            <div class="flex-1">
              <p class="text-sm font-medium text-pblue-600"><a href="<?php $cat = get_the_category();
                                                                      echo get_category_link($cat[0]->cat_ID); ?>" class="hover:underline"><?php echo $cat[0]->name; ?> </a></p>
    ...
    ?>
    <div class="sm:hidden">
      <a href="javascript:void(0)" class="block text-sm font-semibold text-rose-600 hover:text-rose-400">View all blog posts<span aria-hidden="true">→</span></a>
    </div>
  </div>
</div>