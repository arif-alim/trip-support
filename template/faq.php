    ...
    <div class="mx-auto max-w-7xl bg-white px-4">
      <section class="pt-20 pb-12 relative overflow-hidden">
        <div class="container">
          ...
          <div class="d-flex d-flex-wrap gap-12">
            <div class="w-full lg:w-1/2">
              <div class="accordion accordion-flush" id="accordionFlushExample">
                <!-- BEGIN FAQ 1 -->
                <div
                  class="accordion-item my-3 border-t-0 border-l-0 border-r-0 rounded-none border border-gray-200 prose"
                >
                  <h2 class="accordion-header mb-0" id="flush-headingOne">
                    <button
                      class="accordion-button relative flex items-center w-full py-4 text-lg text-gray-800 text-left transition font-semibold active:text-rose-600"
                      type="button"
                  ...
                  >
                    <div
                      class="accordion-body text-gray-700 font-medium"
                    >
                      <p>
                ...
                >
                  <h2 class="accordion-header mb-0" id="flush-headingTwo">
                    <button
                      ...
                      class="accordion-button collapsed relative flex items-center w-full py-4 text-lg text-gray-800 text-left transition font-semibold active:text-rose-600"
                      type="button"
                      data-bs-toggle="collapse"
