...
<main>
			...
			<div class="bg-gradient-to-r from-pblue-900 to-rose-900">
				<div class="max-w-7xl mx-auto px-4">
					<div class="relative pt-6 sm:pt-28 pb-10 sm:pb-48">
						<div>
							<h2 id="sale-heading"
									class="text-4xl font-extrabold tracking-tight text-white md:text-6xl">Book Now, Pay Later
							</h2>
							...
							<div class="mt-4 text-base"><a href="<?php echo home_url() ?>/vacations"
									 class="font-semibold text-white">View Offers<span aria-hidden="true"
												class="ml-2">→</span></a></div>
						</div>
						...
						<div class="hidden sm:flex absolute top-24 left-1/2 transform -translate-x-1/2 sm:top-4 sm:translate-x-0">
							<div class="ml-24 flex space-x-6 min-w-max sm:ml-3 lg:space-x-4">
								<div class="flex space-x-6 sm:flex-col sm:space-x-0 sm:space-y-6 lg:space-y-4">
									...
									<div class="mt-6 flex-shrink-0 sm:mt-0"><img class="h-[200px] w-[180px] rounded-lg object-cover"
												 src="<?php echo THEME_IMAGE_HERO . '/hotel-11.jpg' ?>"
												 alt=""></div>
								</div>
								<div class="flex space-x-6 sm:-mt-20 sm:flex-col sm:space-x-0 sm:space-y-6 lg:space-y-4">
									...
									<div class="mt-6 flex-shrink-0 sm:mt-0"><img class="h-[250px] w-[180px] rounded-lg object-cover"
												 src="<?php echo THEME_IMAGE_HOME . '/flights-section.jpg' ?>"
												 alt="">
									</div>
								</div>
								<div class="flex space-x-6 sm:flex-col sm:space-x-0 sm:space-y-6 lg:space-y-4">
									...
									<div class="mt-6 flex-shrink-0 sm:mt-0"><img class="h-[200px] w-[180px] rounded-lg object-cover"
												 src="<?php echo THEME_IMAGE_HERO . '/muskoka.jpg' ?>"
												 alt=""></div>
								</div>
							</div>
						</div>
	...
	<section class="relative max-w-7xl -mt-5 mx-auto xl:-mt-32 lg:-mt-28 md:-mt-8 px-0 md:px-4 pb-12 lg:mb-6"
  ...
  <section aria-labelledby="features-heading" class="max-w-7xl mx-auto p-4">
    ...
    <div class="mt-4">
      <div class="-mx-4 flex overflow-x-auto sm:mx-0">
        <div class="flex-auto px-4 border-b border-gray-200 sm:px-0">
          <div class="-mb-px flex space-x-10"
                ...
                role="tablist">
            <button id="tab1"
                    class="tab-link-active tab-link border-transparent whitespace-nowrap py-6 border-b-2 font-medium text-tb border-rose-600 text-rose-600&quot;, text-rose-600 font-bold"
                    role="tab"
                    type="button">Weekly Payment Plan
            </button>

            <button id="tab2"
                    class="tab-link border-transparent whitespace-nowrap py-6 border-b-2 font-medium text-tb text-gray-500  hover:text-rose-600 hover:border-rose-600 font-semibold"
                    role="tab"
                    type="button">Bi-Weekly Payment Plan
            </button>
            <button id="tab3"
                    class="tab-link border-transparent whitespace-nowrap py-6 border-b-2 font-medium text-tb text-gray-500  hover:text-rose-600 hover:border-rose-600 font-semibold"
                    role="tab"
                    type="button">Monthly Payment Plan
            </button>
          </div>
        </div>
      </div>
      ...
      <div data-tab="tab1"
            class="tab-link-body tab-link-body-active">
        <div class="flex pt-6">
        ...
        <div class="space-y-16 pt-4 lg:pt-10"
              role="tabpanel">
          <div class="flex flex-col-reverse lg:grid lg:grid-cols-12 lg:gap-x-16">
            <div class="mt-6 lg:mt-0 lg:col-span-8">
              <div class="relative py-12">
                <div
                      class="w-10 md:w-12 absolute top-0 left-0 bottom-0 flex flex-col justify-center lg:left-1/2 lg:-ml-6">
                ...
                <ul class="relative space-y-4 pl-10 md:pl-12 lg:pl-0">
                  <li class="relative lg:w-1/2 lg:pr-6 lg:mr-auto">
                    <div
                          class="w-10 md:w-12 absolute top-0 left-0 bottom-0 -translate-x-full flex justify-center mt-5 lg:translate-x-6 lg:left-auto lg:right-0">
                      <div
                            class="w-3 h-3 bg-indigo-500 rounded-full ring ring-indigo-100 ring-opacity-100 ring-offset-2">
                      </div>
                    </div>
                    ...
                    <div
                          class="px-4 py-2 lg:w-40 lg:absolute lg:top-0 lg:right-0 lg:bottom-0 lg:translate-x-full lg:flex lg:flex-col lg:mt-4 lg:py-0 lg:pr-0 lg:pl-6">
                  ...
                  <li class="relative lg:w-1/2 lg:pl-6 lg:ml-auto">
                    <div
                          class="w-10 md:w-12 absolute top-0 left-0 bottom-0 -translate-x-full flex justify-center mt-5 lg:-translate-x-6">
                      <div
                            class="w-3 h-3 bg-indigo-500 rounded-full ring ring-indigo-100 ring-opacity-100 ring-offset-2">
                      </div>
                    </div>
                    ...
                    <div
                          class="px-4 py-2 lg:w-40 lg:absolute lg:top-0 lg:left-0 lg:bottom-0 lg:-translate-x-full lg:flex lg:flex-col lg:text-right lg:mt-4 lg:py-0 lg:pl-0 lg:pr-6">
              ...
              <div class="flex mt-4">
                <p class="text-xs text-gray-500">Some conditions do apply.
                  ...
                  see our
                  <a href="#"
                      class="text-rose-600">Pay Later Terms</a>.
                </p>
              </div>
            </div>
	...
	<div class="bg-white overflow-hidden">
		...
		<div
				 class="d-flex flex-col lg:flex-row-reverse space-y-16 lg:space-y-0 lg:text-left container xl:max-w-7xl mx-auto px-4 py-16 gap-x-12">
			<div class="lg:w-1/3 lg:flex lg:justify-center lg:items-center">
				<div class="lg:w-96 relative">
					...
					<div
							 class="absolute rounded-xl bottom-0 left-0 w-32 h-32 bg-blue-200 bg-opacity-50 -mb-10 -ml-10 transform rotate-3">
					</div>
			...
			<div class="lg:w-2/3 lg:flex">
				<div>
					<div
							 class="font-medium inline-flex px-2 py-1.5 leading-4 mb-4 text-sm rounded text-emerald-700 bg-emerald-200">
            ...
            Book Now Pay Later allows you to pay off flights in installments. Everyone is eligible for the book now pay later plan with no credit check required. All you have to do is Book Now and Pay using our easy monthly installment options.
					...
					<div class="lg:w-full lg:flex pt-10">
						<div>
							...
							<div
									 class="flex w-1/2 flex-col sm:flex-row sm:items-center justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-2 py-6 mb-6">
				...
				<div class="space-y-4">
					...
					<div class="bg-gray-100 rounded p-5">
						...
						<p class="text-sm text-gray-600 leading-relaxed line-clamp-3">Depending on your destination, you may need to
							...
							<a class="text-rose-600 hover:text-rose-500"
								 href="#">https://visacentral.com/</a>
						</p>
					</div>
